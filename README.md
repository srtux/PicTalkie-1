...
This project was developed for the **Pittsburgh Regional Science & Engineering Fair**. All algorithms (Baird mapping, Hilbert traversal, AFSK sync) were customized specifically for high-noise radio propagation.

...
PicTalkie uses **black-bar padding** instead of cropping to square. In emergency or science fair demos, preserving the *entire* image is prioritized over aesthetic fill-screen crops.
...
## 🏆 Project Origin
This project was originally developed for the **Pittsburgh Regional Science & Engineering Fair**.
